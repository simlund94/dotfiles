...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      workspaces = {
        {
          name = 'obsidian-vault',
          path = '~/Documents/Skolarbeten/0-obsidian-vault',
        },
      },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[_] Fuzzily search in current buffer' })
        ...
        texlab = {
          ...
          settings = {
            texlab = {
              ...
              forwardSearch = {
                executable = 'zathura', -- change to your PDF viewer (e.g., evince, okular, sumatra)
                args = { '%p' },
              },
